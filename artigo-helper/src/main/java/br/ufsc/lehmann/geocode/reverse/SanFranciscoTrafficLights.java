...
public class SanFranciscoTrafficLights {
	...
	public static void main(String[] args) throws NumberFormatException, ZipException, IOException, ParseException, URISyntaxException {
		File trafficLightFile = new File("C:/Users/André/git/ArtigoMSM_UFSC/artigo/src/main/resources/datasets/sanfrancisco.stop.traffic_light.csv");
