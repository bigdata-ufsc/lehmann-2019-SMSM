...
public class SMoT_Geolife_inside_enhanced {

	private static DataSource source;

	public static void main(String[] args) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		String movesTable = "stops_moves.geolife_inside_enhanced_move";
		String stopsTable = "stops_moves.geolife_inside_enhanced_stop";
		String pointsTable = "geolife.geolife_inside_university_5_pois_enhanced";
		List<SemanticTrajectory> trajs = new GeolifeDatabaseReader(false, false, stopsTable, movesTable, pointsTable).read();
		source = new DataSource("postgres", "postgres", "localhost", 5432, "postgis", DataSourceType.PGSQL, pointsTable, null, "geom");
