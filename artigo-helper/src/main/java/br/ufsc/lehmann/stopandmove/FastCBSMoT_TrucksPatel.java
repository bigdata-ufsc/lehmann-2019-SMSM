...
public class FastCBSMoT_TrucksPatel {
	...
	public static void main(String[] args) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		...
		PatelProblem problem = new PatelProblem("trucks", "vehicle");
		...
		PreparedStatement update = conn.prepareStatement("update patel.trucks set semantic_stop_id = ?, semantic_move_id = ? where tid = ? and gid in (SELECT * FROM unnest(?))");
