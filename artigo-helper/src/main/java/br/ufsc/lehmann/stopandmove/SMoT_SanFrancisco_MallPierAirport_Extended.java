...
public class SMoT_SanFrancisco_MallPierAirport_Extended {

	private static DataSource source;

	public static void main(String[] args) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		String stopsTable = "stops_moves.sanfrancisco_taxicab_airport_mall_extended_stop";
		String movesTable = "stops_moves.sanfrancisco_taxicab_airport_mall_extended_move";
