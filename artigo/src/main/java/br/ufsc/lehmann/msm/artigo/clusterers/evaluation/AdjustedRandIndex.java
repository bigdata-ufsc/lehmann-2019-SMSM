 ...
 * {@link #evaluate(int[], Trajectories) } will work, since it provides the data
 * set as an argument.
 * 
 * @author Edward Raff
 * @author Andre Lehmann
 */
public class AdjustedRandIndex<T> implements ClusterEvaluation<T>
{
