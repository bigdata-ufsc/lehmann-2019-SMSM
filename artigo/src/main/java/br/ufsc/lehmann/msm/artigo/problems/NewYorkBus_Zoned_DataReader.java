...
public class NewYorkBus_Zoned_DataReader {
	...
	public static final StopSemantic STOP_REGION_SEMANTIC = new StopSemantic(10, new AttributeDescriptor<Stop, String>(AttributeType.STOP_REGION, new EqualsDistanceFunction<String>()));
	...
	public NewYorkBus_Zoned_DataReader(boolean onlyStops) {
