...
public class NewYorkBus_Zoned_Cleaned_Problem extends NewYorkBusProblem {
	...
	public NewYorkBus_Zoned_Cleaned_Problem(String... lines) {
		this(NewYorkBus_Zoned_DatabaseReader.STOP_CENTROID_SEMANTIC, lines);
	}
	
	public NewYorkBus_Zoned_Cleaned_Problem(StopSemantic stopSemantic, String... zones) {
		this(stopSemantic, false, zones);
	}
	
	public NewYorkBus_Zoned_Cleaned_Problem(StopSemantic stopSemantic, boolean onlyStops, String... zones) {
		this(stopSemantic, StopMoveStrategy.CBSMoT, onlyStops, zones);
	}
	
	public NewYorkBus_Zoned_Cleaned_Problem(StopSemantic stopSemantic, StopMoveStrategy strategy, boolean onlyStops, String... zones) {
		this(stopSemantic, strategy, onlyStops, false, zones);
	}
	
	public NewYorkBus_Zoned_Cleaned_Problem(StopSemantic stopSemantic, StopMoveStrategy strategy, boolean onlyStops, boolean withDirection, String... zones) {
		super(stopSemantic);
...
//		}
		try {
			return new ArrayList<>(new NewYorkBus_Zoned_Cleaned_DatabaseReader(onlyStops).read(zones));
