...
public interface MSMMoveDistanceTest {
	...
	default IMeasureDistance<SemanticTrajectory> measurer(Problem problem) {
		if(problem instanceof NElementProblem) {
			...
			return new MSMMoveClassifier(new SMSMSemanticParameter(((DublinBusProblem) problem).stopSemantic(), Thresholds.STOP_CENTROID_LATLON, DublinBusDataReader.MOVE_DISTANCE_SEMANTIC, Thresholds.MOVE_DISTANCE, .5)
					, new MSMSemanticParameter<TPoint, Number>(Semantic.GEOGRAPHIC_LATLON, Thresholds.GEOGRAPHIC_LATLON, .5),
					new MSMSemanticParameter<TemporalDuration, Number>(Semantic.TEMPORAL, Thresholds.TEMPORAL, .5)
					);
		} else if(problem instanceof PatelProblem) {
			return new MSMMoveClassifier(new SMSMSemanticParameter(((PatelProblem) problem).stopSemantic(), Thresholds.STOP_CENTROID_EUCLIDEAN, PatelDataReader.MOVE_DISTANCE_SEMANTIC, Thresholds.MOVE_DISTANCE, .5)
			...
			return new MSMMoveClassifier(new SMSMSemanticParameter(((VehicleProblem) problem).stopSemantic(), Thresholds.STOP_CENTROID_EUCLIDEAN, PatelDataReader.MOVE_DISTANCE_SEMANTIC, Thresholds.MOVE_DISTANCE, .5)
					, new MSMSemanticParameter<TPoint, Number>(Semantic.GEOGRAPHIC_EUCLIDEAN, Thresholds.GEOGRAPHIC_EUCLIDEAN, .5),
					new MSMSemanticParameter<TemporalDuration, Number>(Semantic.TEMPORAL, Thresholds.TEMPORAL, .5)
					);
		} else if(problem instanceof SanFranciscoCabProblem) {
			return new MSMMoveClassifier(new SMSMSemanticParameter(((SanFranciscoCabProblem) problem).stopSemantic(), Thresholds.STOP_CENTROID_LATLON, SanFranciscoCabDataReader.MOVE_DISTANCE_SEMANTIC, Thresholds.MOVE_DISTANCE, .5)
					,new MSMSemanticParameter<TPoint, Number>(Semantic.GEOGRAPHIC_LATLON, Thresholds.GEOGRAPHIC_LATLON, .5),
					new MSMSemanticParameter<TemporalDuration, Number>(Semantic.TEMPORAL, Thresholds.TEMPORAL, .5)
					);
		} else if(problem instanceof SergipeTracksProblem) {
			return new MSMMoveClassifier(new SMSMSemanticParameter(SergipeTracksDataReader.STOP_CENTROID_SEMANTIC, Thresholds.STOP_CENTROID_LATLON, SergipeTracksDataReader.MOVE_DISTANCE_SEMANTIC, Thresholds.MOVE_DISTANCE, .5)
					, new MSMSemanticParameter<TPoint, Number>(Semantic.GEOGRAPHIC_LATLON, Thresholds.GEOGRAPHIC_LATLON, .5),
					new MSMSemanticParameter<TemporalDuration, Number>(Semantic.TEMPORAL, Thresholds.TEMPORAL, .5)
					);
			...
			return new MSMMoveClassifier(new SMSMSemanticParameter(((PisaProblem) problem).stopSemantic(), null, PisaDataReader.MOVE_DISTANCE_SEMANTIC, Thresholds.MOVE_DISTANCE, .5)
					, new MSMSemanticParameter<TPoint, Number>(Semantic.GEOGRAPHIC_LATLON, Thresholds.GEOGRAPHIC_LATLON, .5),
					new MSMSemanticParameter<TemporalDuration, Number>(Semantic.TEMPORAL, Thresholds.TEMPORAL, .5)
					);
		}
