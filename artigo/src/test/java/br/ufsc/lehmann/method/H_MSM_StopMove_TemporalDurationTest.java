...
public interface H_MSM_StopMove_TemporalDurationTest {
	...
	default IMeasureDistance<SemanticTrajectory> measurer(Problem problem) {
		if(problem instanceof NElementProblem) {
			...
			return new H_MSM_StopMove_Classifier(//
					new H_MSM_StopMove.H_MSM_MoveSemanticParameters(NewYorkBusDataReader.MOVE_TEMPORAL_DURATION_SEMANTIC, new H_MSM_StopMove.H_MSM_DimensionParameters[] {
							new H_MSM_StopMove.H_MSM_DimensionParameters<>(NewYorkBusDataReader.MOVE_TEMPORAL_DURATION_SEMANTIC, AttributeType.MOVE, Thresholds.MOVE_DURATION, 1)
						}),
			...
			return new H_MSM_StopMove_Classifier(//
					new H_MSM_StopMove.H_MSM_MoveSemanticParameters(DublinBusDataReader.MOVE_TEMPORAL_DURATION_SEMANTIC, new H_MSM_StopMove.H_MSM_DimensionParameters[] {
							new H_MSM_StopMove.H_MSM_DimensionParameters<>(DublinBusDataReader.MOVE_TEMPORAL_DURATION_SEMANTIC, AttributeType.MOVE, Thresholds.MOVE_DURATION, 1)
						}),
			...
			return new H_MSM_StopMove_Classifier(//
					new H_MSM_StopMove.H_MSM_MoveSemanticParameters(PatelDataReader.MOVE_TEMPORAL_DURATION_SEMANTIC, new H_MSM_StopMove.H_MSM_DimensionParameters[] {
							new H_MSM_StopMove.H_MSM_DimensionParameters<>(PatelDataReader.MOVE_TEMPORAL_DURATION_SEMANTIC, AttributeType.MOVE, Thresholds.MOVE_DURATION, 1)
						}),
			...
			return new H_MSM_StopMove_Classifier(//
					new H_MSM_StopMove.H_MSM_MoveSemanticParameters(SanFranciscoCabDataReader.MOVE_TEMPORAL_DURATION_SEMANTIC, new H_MSM_StopMove.H_MSM_DimensionParameters[] {
							new H_MSM_StopMove.H_MSM_DimensionParameters<>(SanFranciscoCabDataReader.MOVE_TEMPORAL_DURATION_SEMANTIC, AttributeType.MOVE, Thresholds.MOVE_DURATION, 1)
						}),
			...
			return new H_MSM_StopMove_Classifier(//
					new H_MSM_StopMove.H_MSM_MoveSemanticParameters(SergipeTracksDataReader.MOVE_TEMPORAL_DURATION_SEMANTIC, new H_MSM_StopMove.H_MSM_DimensionParameters[] {
							new H_MSM_StopMove.H_MSM_DimensionParameters<>(SergipeTracksDataReader.MOVE_TEMPORAL_DURATION_SEMANTIC, AttributeType.MOVE, Thresholds.MOVE_DURATION, 1)
						}),
			...
			return new H_MSM_StopMove_Classifier(//
					new H_MSM_StopMove.H_MSM_MoveSemanticParameters(PisaDataReader.MOVE_TEMPORAL_DURATION_SEMANTIC, new H_MSM_StopMove.H_MSM_DimensionParameters[] {
							new H_MSM_StopMove.H_MSM_DimensionParameters<>(PisaDataReader.MOVE_TEMPORAL_DURATION_SEMANTIC, AttributeType.MOVE, Thresholds.MOVE_DURATION, 1)
						}),
