	...
	default IMeasureDistance<SemanticTrajectory> measurer(Problem problem) {
		if(problem instanceof NElementProblem) {
			return new H_MSM_Classifier(//
						new H_MSM.H_MSM_MoveSemanticParameters(NElementProblem.move_distance, new H_MSM.H_MSM_DimensionParameters[] {
			...
			return new H_MSM_Classifier(//
					new H_MSM.H_MSM_MoveSemanticParameters(NewYorkBusDataReader.MOVE_DISTANCE_SEMANTIC, new H_MSM.H_MSM_DimensionParameters[] {
			...
			return new H_MSM_Classifier(//
					new H_MSM.H_MSM_MoveSemanticParameters(DublinBusDataReader.MOVE_DISTANCE_SEMANTIC, new H_MSM.H_MSM_DimensionParameters[] {
			...
			return new H_MSM_Classifier(//
					new H_MSM.H_MSM_MoveSemanticParameters(PatelDataReader.MOVE_DISTANCE_SEMANTIC, new H_MSM.H_MSM_DimensionParameters[] {
			...
			return new H_MSM_Classifier(//
					new H_MSM.H_MSM_MoveSemanticParameters(SanFranciscoCabDataReader.MOVE_DISTANCE_SEMANTIC, new H_MSM.H_MSM_DimensionParameters[] {
			...
			return new H_MSM_Classifier(//
					new H_MSM.H_MSM_MoveSemanticParameters(SergipeTracksDataReader.MOVE_DISTANCE_SEMANTIC, new H_MSM.H_MSM_DimensionParameters[] {
			...
			return new H_MSM_Classifier(//
					new H_MSM.H_MSM_MoveSemanticParameters(PisaDataReader.MOVE_DISTANCE_SEMANTIC, new H_MSM.H_MSM_DimensionParameters[] {
