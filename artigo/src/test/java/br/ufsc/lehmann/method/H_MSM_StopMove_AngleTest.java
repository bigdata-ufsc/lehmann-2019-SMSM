...
public interface H_MSM_StopMove_AngleTest {
	...
	default IMeasureDistance<SemanticTrajectory> measurer(Problem problem) {
		if(problem instanceof NElementProblem) {
			...
			return new H_MSM_StopMove_Classifier(//
					new H_MSM_StopMove.H_MSM_MoveSemanticParameters(NewYorkBusDataReader.MOVE_ANGLE_SEMANTIC, new H_MSM_StopMove.H_MSM_DimensionParameters[] {
							new H_MSM_StopMove.H_MSM_DimensionParameters<>(NewYorkBusDataReader.MOVE_ANGLE_SEMANTIC, AttributeType.MOVE, Thresholds.MOVE_ANGLE, 1)
						}),
			...
			return new H_MSM_StopMove_Classifier(//
					new H_MSM_StopMove.H_MSM_MoveSemanticParameters(DublinBusDataReader.MOVE_ANGLE_SEMANTIC, new H_MSM_StopMove.H_MSM_DimensionParameters[] {
							new H_MSM_StopMove.H_MSM_DimensionParameters<>(DublinBusDataReader.MOVE_ANGLE_SEMANTIC, AttributeType.MOVE, Thresholds.MOVE_ANGLE, 1)
						}),
			...
			return new H_MSM_StopMove_Classifier(//
					new H_MSM_StopMove.H_MSM_MoveSemanticParameters(PatelDataReader.MOVE_ANGLE_SEMANTIC, new H_MSM_StopMove.H_MSM_DimensionParameters[] {
							new H_MSM_StopMove.H_MSM_DimensionParameters<>(PatelDataReader.MOVE_ANGLE_SEMANTIC, AttributeType.MOVE, Thresholds.MOVE_ANGLE, 1)
						}),
			...
			return new H_MSM_StopMove_Classifier(//
					new H_MSM_StopMove.H_MSM_MoveSemanticParameters(SanFranciscoCabDataReader.MOVE_ANGLE_SEMANTIC, new H_MSM_StopMove.H_MSM_DimensionParameters[] {
							new H_MSM_StopMove.H_MSM_DimensionParameters<>(SanFranciscoCabDataReader.MOVE_ANGLE_SEMANTIC, AttributeType.MOVE, Thresholds.MOVE_ANGLE, 1)
						}),
			...
			return new H_MSM_StopMove_Classifier(//
					new H_MSM_StopMove.H_MSM_MoveSemanticParameters(SergipeTracksDataReader.MOVE_ANGLE_SEMANTIC, new H_MSM_StopMove.H_MSM_DimensionParameters[] {
							new H_MSM_StopMove.H_MSM_DimensionParameters<>(SergipeTracksDataReader.MOVE_ANGLE_SEMANTIC, AttributeType.MOVE, Thresholds.MOVE_ANGLE, 1)
						}),
			...
			return new H_MSM_StopMove_Classifier(//
					...
					new H_MSM_StopMove.H_MSM_StopSemanticParameters(PrototypeDataReader.STOP_SEMANTIC, new H_MSM_StopMove.H_MSM_DimensionParameters[] {
							...
							new H_MSM_StopMove.H_MSM_DimensionParameters<>(Semantic.TEMPORAL, AttributeType.STOP_TEMPORAL, Thresholds.TEMPORAL, 1.0/3.0),
							new H_MSM_StopMove.H_MSM_DimensionParameters<>(PrototypeDataReader.STOP_SEMANTIC, AttributeType.STOP_NAME, null, 1.0/3.0)
						})
					);
		} else if(problem instanceof PisaProblem) {
			return new H_MSM_StopMove_Classifier(//
					new H_MSM_StopMove.H_MSM_MoveSemanticParameters(PisaDataReader.MOVE_ANGLE_SEMANTIC, new H_MSM_StopMove.H_MSM_DimensionParameters[] {
							new H_MSM_StopMove.H_MSM_DimensionParameters<>(PisaDataReader.MOVE_ANGLE_SEMANTIC, AttributeType.MOVE, Thresholds.MOVE_ANGLE, 1)
						}),
