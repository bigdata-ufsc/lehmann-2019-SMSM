	...
	default IMeasureDistance<SemanticTrajectory> measurer(Problem problem) {
		...
		return new SMSMClassifier(//
				new SMSM.H_MSM_MoveSemanticParameters(ellipseMoveSemantic, new SMSM.H_MSM_DimensionParameters[] {
						...
						new SMSM.H_MSM_DimensionParameters<>(distanceMoveSemantic, AttributeType.MOVE, Thresholds.MOVE_DISTANCE, 1.0/3.0),
						new SMSM.H_MSM_DimensionParameters<>(temporalDurationMoveSemantic, AttributeType.MOVE, Thresholds.MOVE_DURATION, 1.0/3.0)
					}),
