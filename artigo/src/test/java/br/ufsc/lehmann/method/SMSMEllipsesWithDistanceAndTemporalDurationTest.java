...
public interface SMSMEllipsesWithDistanceAndTemporalDurationTest {
	...
	default IMeasureDistance<SemanticTrajectory> measurer(Problem problem) {
		...
		return new SMSMClassifier(//
				new SMSM.SMSM_MoveSemanticParameters(ellipseMoveSemantic, new SMSM.SMSM_DimensionParameters[] {
						new SMSM.SMSM_DimensionParameters<>(ellipseMoveSemantic, AttributeType.MOVE, Thresholds.MOVE_INNER_POINTS_PERC, 1.0/3.0),
						new SMSM.SMSM_DimensionParameters<>(distanceMoveSemantic, AttributeType.MOVE, Thresholds.MOVE_DISTANCE, 1.0/3.0),
						new SMSM.SMSM_DimensionParameters<>(temporalDurationMoveSemantic, AttributeType.MOVE, Thresholds.MOVE_DURATION, 1.0/3.0)
					}),
