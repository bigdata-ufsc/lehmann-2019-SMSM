						...
						switch(type) {
							...
							case "SEMANTIC":
								...
								case "UMS":
									...
									Param dtwParam = dtwParams.get(0);
									String dtwDistance = dtwParam.getDistance().toUpperCase();
									SpatialDistanceFunction spatialDistance1 = null;
									switch(dtwDistance) {
										case "LATLON":
											spatialDistance1 = new LatLongDistanceFunction();
											break;
										case "EUCLIDEAN":
											spatialDistance1 = new EuclideanDistanceFunction();
											break;
									}
									if(semDistance.equals("UMS")) {
										distance = new EllipsesDistance(spatialDistance1);
									} else {
										distance = new DTWDistance(spatialDistance1);
									}
									break;
								default:
									distance = new EqualsDistanceFunction<>();
